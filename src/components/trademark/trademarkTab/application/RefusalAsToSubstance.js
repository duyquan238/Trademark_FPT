...
const RefusalAsToSubstance = (props) => {
          ...
          <Grid item xs={6} lg={6}>
            ...
            >
              <DialogTitle onClose={handleAddNotiDialogClose}>
                Notification of Refusal as to substance
              </DialogTitle>
              <Formik
                initialValues={{
                  id: null,
                ...
                onSubmit={(values) => {
                  if (isEdit) {
                    ...
                    const data = {
                      ...
                      deadline: calDeadlineDate(values.notiDate, 3).format(
                        "YYYY-MM-DD"
                      ),
...
export default RefusalAsToSubstance;
